...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#e0f7ff] via-[#e9fff8] to-[#e0ffee] px-safe relative overflow-hidden">
      {/* 装飾的な波線 - 上部 */}
      ...
      {/* iPhone 16のノッチ部分のための余白 */}
      <div className="h-safe-top" />

      {/* メインコンテンツ */}
      <div className="flex-1 flex flex-col items-center justify-between px-6 pt-8 pb-safe-bottom max-w-[390px] mx-auto relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-4xl font-bold mt-6 mb-8">かもかも診断</h2>

          {/* かものキャラクターを横並びに表示 */}
          <div className="flex justify-center items-center gap-1 mb-8">
            <div className="relative w-36 h-40">
            <img src="/images/kamo1.png" alt="かもキャラクター1" width={120} height={150} className="object-contain" />
            </div>
            <div className="relative w-36 h-40">
            <img src="/images/kamo2.png" alt="かもキャラクター2" width={120} height={150} className="object-contain" />
            </div>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center gap-8 mb-4">
          <button className="w-full bg-black text-white py-4 px-6 rounded-full text-xl font-medium shadow-md hover:bg-gray-800 transition-colors">
            はじめる
          </button>
          ...
          <Link href="/admin" className="text-sm text-[#1b50fc]">
            管理者ログインはこちら
          </Link>
        </div>
      </div>
